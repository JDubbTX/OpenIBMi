...
dcl-pr clpgm extpgm('MYFIRSTCL'); // Declare the cl program as an external program
...
4.  Select Changes
5.  All changed source files will be packaged and deployed to the IBM i partition's IFS build directory, and then CRTBNDCL will be run against it.
...
### Setting up the project for Bob
